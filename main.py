...
#A unified objtective QoS-QoE model of youtube streaming: A network point of por
minSamplesLeaf=20
totalRuns=1
nIterations=10000
numberOfClasses=2
...
datasetMongo =db["datasetYouTube_crypted_wifi_tc_set_20mbps"]
iteration=0
...
try:
    ...
    #print point
    #pcapProcess=subprocess.Popen(["tcpdump","-s","0","-        ","YouTube_"+videoKeywords[v]+"_"+videoIDs[v]+"_"+resolutions[r]+".pcap"])
